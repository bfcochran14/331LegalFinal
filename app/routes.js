...
//scrub question 14
//scrub question 18
if(req.body.question14 == 'item1')
	req.body.question14 = 'Alabama';
else if (req.body.question14 == 'item2') {
	req.body.question14 = 'Alaska';
}
else if (req.body.question14 == 'item3') {
	req.body.question14 = 'Arizona';
}
else if (req.body.question14 == 'item4') {
	req.body.question14 = 'Arkansas';
}
else if (req.body.question14 == 'item5') {
	req.body.question14 = 'Calafornia';
}
else if (req.body.question14 == 'item6') {
	req.body.question14 = 'Colorado';
}
else if (req.body.question14 == 'item7') {
	req.body.question14 = 'Connecticut';
}
else if (req.body.question14 == 'item8') {
	req.body.question14 = 'Delaware';
}
else if (req.body.question14 == 'item9') {
	req.body.question14 = 'Florida';
}
else if (req.body.question14 == 'item10') {
	req.body.question14 = 'Georgia';
}
else if (req.body.question14 == 'item11') {
	req.body.question14 = 'Hawaii';
}
else if (req.body.question14 == 'item12') {
	req.body.question14 = 'Idaho';
}
else if (req.body.question14 == 'item13') {
	req.body.question14 = 'Illinois';
}
else if (req.body.question14 == 'item14') {
	req.body.question14 = 'Indiana';
}
else if (req.body.question14 == 'item15') {
	req.body.question14 = 'Iowa';
}
else if (req.body.question14 == 'item16') {
	req.body.question14 = 'Kansas';
}
else if (req.body.question14 == 'item17') {
	req.body.question14 = 'Kentucky';
}
else if (req.body.question14 == 'item18') {
	req.body.question14 = 'Louisiana';
}
else if (req.body.question14 == 'item19') {
	req.body.question14 = 'Maine';
}
else if (req.body.question14 == 'item20') {
	req.body.question14 = 'Maryland';
}
else if (req.body.question14 == 'item21') {
	req.body.question14 = 'Massachusetts';
}
else if (req.body.question14 == 'item22') {
	req.body.question14 = 'Michigan';
}
else if (req.body.question14 == 'item23') {
	req.body.question14 = 'Minnesota';
}
else if (req.body.question14 == 'item24') {
	req.body.question14 = 'Mississippi';
}
else if (req.body.question14 == 'item25') {
	req.body.question14 = 'Missouri';
}
else if (req.body.question14 == 'item26') {
	req.body.question14 = 'Montana';
}
else if (req.body.question14 == 'item27') {
	req.body.question14 = 'Nebraska';
}
else if (req.body.question14 =='item28' ) {
	req.body.question14 = 'Nevada';
}
else if (req.body.question14 == 'item29') {
	req.body.question14 = 'New Hampshire';
}
else if (req.body.question14 == 'item30' ) {
	req.body.question14 = 'New Jersey';
}
else if (req.body.question14 == 'item31') {
	req.body.question14 = 'New Mexico';
}
else if (req.body.question14 == 'item32') {
	req.body.question14 = 'New York';
}
else if (req.body.question14 == 'item33') {
	req.body.question14 = 'North Carolina';
}
else if (req.body.question14 == 'item34') {
	req.body.question14 = 'North Dakota';
}
else if (req.body.question14 == 'item35' ) {
	req.body.question14 = 'Ohio';
}
else if (req.body.question14 == 'item36') {
	req.body.question14 = 'Oklahoma';
}
else if (req.body.question14 == 'item37') {
	req.body.question14 = 'Oregon';
}
else if (req.body.question14 == 'item38') {
	req.body.question14 = 'Pennsylvania';
}
else if (req.body.question14 == 'item39') {
	req.body.question14 = 'Rhode Island';
}
else if (req.body.question14 == 'item40') {
	req.body.question14 = 'South Carolina';
}
else if (req.body.question14 == 'item41') {
	req.body.question14 = 'South Dakota';
}
else if (req.body.question14 == 'item42') {
	req.body.question14 = 'Tennessee';
}
else if (req.body.question14 == 'item43') {
	req.body.question14 = 'Texas';
}
else if (req.body.question14 == 'item44') {
	req.body.question14 = 'Utah';
}
else if (req.body.question14 == 'item45') {
	req.body.question14 = 'Vermont';
}
else if (req.body.question14 == 'item46') {
	req.body.question14 = 'Virginia';
}
else if (req.body.question14 == 'item47') {
	req.body.question14 = 'Washington';
}
else if (req.body.question14 == 'item48') {
	req.body.question14 = 'West Virginia';
}
else if (req.body.question14 == 'item49') {
	req.body.question14 = 'Wisconsin';
}
else if (req.body.question14 == 'item50') {
	req.body.question14 = 'Wyoming';
}
else if (req.body.question14 == 'item51') {
	req.body.question14 = 'Puerto Rico';
}
else if (req.body.question14 == 'item52') {
	req.body.question14 = 'District of Columbia';
}
else{
	req.body.question14 = ''
}
...
//scrub question 18
if(req.body.question18 == 'item1')
	req.body.question18 = 'Alabama';
else if (req.body.question18 == 'item2') {
	req.body.question18 = 'Alaska';
}
else if (req.body.question18 == 'item3') {
	req.body.question18 = 'Arizona';
}
else if (req.body.question18 == 'item4') {
	req.body.question18 = 'Arkansas';
}
else if (req.body.question18 == 'item5') {
	req.body.question18 = 'Calafornia';
}
else if (req.body.question18 == 'item6') {
	req.body.question18 = 'Colorado';
}
else if (req.body.question18 == 'item7') {
	req.body.question18 = 'Connecticut';
}
else if (req.body.question18 == 'item8') {
	req.body.question18 = 'Delaware';
}
else if (req.body.question18 == 'item9') {
	req.body.question18 = 'Florida';
}
else if (req.body.question18 == 'item10') {
	req.body.question18 = 'Georgia';
}
else if (req.body.question18 == 'item11') {
	req.body.question18 = 'Hawaii';
}
else if (req.body.question18 == 'item12') {
	req.body.question18 = 'Idaho';
}
else if (req.body.question18 == 'item13') {
	req.body.question18 = 'Illinois';
}
else if (req.body.question18 == 'item14') {
	req.body.question8 = 'Indiana';
}
else if (req.body.question18 == 'item15') {
	req.body.question18 = 'Iowa';
}
else if (req.body.question18 == 'item16') {
	req.body.question18 = 'Kansas';
}
else if (req.body.question18 == 'item17') {
	req.body.question18 = 'Kentucky';
}
else if (req.body.question18 == 'item18') {
	req.body.question18 = 'Louisiana';
}
else if (req.body.question18 == 'item19') {
	req.body.question18 = 'Maine';
}
else if (req.body.question18 == 'item20') {
	req.body.question18 = 'Maryland';
}
else if (req.body.question18 == 'item21') {
	req.body.question18 = 'Massachusetts';
}
else if (req.body.question18 == 'item22') {
	req.body.question18 = 'Michigan';
}
else if (req.body.question18 == 'item23') {
	req.body.question18 = 'Minnesota';
}
else if (req.body.question18 == 'item24') {
	req.body.question18 = 'Mississippi';
}
else if (req.body.question18 == 'item25') {
	req.body.question18 = 'Missouri';
}
else if (req.body.question18 == 'item26') {
	req.body.question18 = 'Montana';
}
else if (req.body.question18 == 'item27') {
	req.body.question18 = 'Nebraska';
}
else if (req.body.question18 =='item28' ) {
	req.body.question18 = 'Nevada';
}
else if (req.body.question18 == 'item29') {
	req.body.question18 = 'New Hampshire';
}
else if (req.body.question18 == 'item30' ) {
	req.body.question18 = 'New Jersey';
}
else if (req.body.question18 == 'item31') {
	req.body.question18 = 'New Mexico';
}
else if (req.body.question18 == 'item32') {
	req.body.question18 = 'New York';
}
else if (req.body.question18 == 'item33') {
	req.body.question18 = 'North Carolina';
}
else if (req.body.question18 == 'item34') {
	req.body.question18 = 'North Dakota';
}
else if (req.body.question18 == 'item35' ) {
	req.body.question18 = 'Ohio';
}
else if (req.body.question18 == 'item36') {
	req.body.question18 = 'Oklahoma';
}
else if (req.body.question18 == 'item37') {
	req.body.question18 = 'Oregon';
}
else if (req.body.question18 == 'item38') {
	req.body.question18 = 'Pennsylvania';
}
else if (req.body.question18 == 'item39') {
	req.body.question18 = 'Rhode Island';
}
else if (req.body.question18 == 'item40') {
	req.body.question18 = 'South Carolina';
}
else if (req.body.question18 == 'item41') {
	req.body.question18 = 'South Dakota';
}
else if (req.body.question18 == 'item42') {
	req.body.question18 = 'Tennessee';
}
else if (req.body.question18 == 'item43') {
	req.body.question18 = 'Texas';
}
else if (req.body.question18 == 'item44') {
	req.body.question18 = 'Utah';
}
else if (req.body.question18 == 'item45') {
	req.body.question18 = 'Vermont';
}
else if (req.body.question18 == 'item46') {
	req.body.question18 = 'Virginia';
}
else if (req.body.question18 == 'item47') {
	req.body.question18 = 'Washington';
}
else if (req.body.question18 == 'item48') {
	req.body.question18 = 'West Virginia';
}
else if (req.body.question18 == 'item49') {
	req.body.question18 = 'Wisconsin';
}
else if (req.body.question18 == 'item50') {
	req.body.question18 = 'Wyoming';
}
else if (req.body.question18 == 'item51') {
	req.body.question18 = 'Puerto Rico';
}
else if (req.body.question18 == 'item52') {
	req.body.question18 = 'District of Columbia';
}
else{
	req.body.question18 = ''
}
...
function showPDF(data, res) {
	...
	*/
	var dpgender = data.question13
	var rgender = data.question12
	//Data scrubbing//
	...
	//19- purpose- <p>
	//20- more purpose - we dont use this
	//21- state location <sloc>
	//22- address location if law suit <aloc>

    var inputs = [data.question2, /*data.question3,*/ data.question4, data.question5, data.question6, registeredAns, data.question8, dppossesive, rppossesive, dppronoun, rppronoun, data.question9, data.question10, data.question11, data.question14, data.question15, aORan, data.question19, data.question21, data.question22];
	...
	var keys = ['<dp>', '<r>', '<le>', '<dpstate>', '<isR>', '<dpRstate>', '<itsdp!>', '<itsr!>', '<itdp!>', '<itr!>', '<today>', '<dp-loc>', '<r-loc>', '<rState>', '<exp>', '<a>', '<p>', '<sloc>', '<aloc>' ];
